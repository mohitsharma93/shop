...
const OrderDetails = ({ match }) => {
	...
	const { orderDetailsInProcess, error, order } = useSelector(
  ...
  const shippingDetail =  shippingAddress && `${shippingAddress.address}, ${shippingAddress.city}, ${shippingAddress.postalCode}, ${shippingAddress.state}, ${shippingAddress.country} `;
